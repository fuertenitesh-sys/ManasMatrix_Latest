...
const AboutTabbed = () => {
  ...
  return (
    <section className="about-tabbed-section" style={{ marginTop: '60px', marginBottom: '60px' }}>
      <div className="section-header animate-reveal fade-up">
        <div className="section-badge">
          <BrainIcon size={14} color="#F59E0B" />
          <span>Strategic Brain Solutions</span>
        </div>
        <h2 className="section-title">
          Explore Our <span className="gradient-text-gold">Brain Intelligence Programs</span>
        </h2>
        <div className="divider"></div>
        <p className="section-subtitle">
          Select any program below to discover how our scientific analysis and personalized mentorship transform learning, careers, and enterprise growth.
        </p>
      </div>
