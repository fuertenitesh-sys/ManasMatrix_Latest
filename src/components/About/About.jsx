...
import { BrainIcon, DnaIcon, BarChartIcon, UsersIcon, CheckIcon, StarIcon, GraduationCapIcon } from '../Icons';
import './About.css';
  ...
  return (
    <section className="section about" id="about">
      <div className="container">
        {/* Main About Grid - Image 2 Requirement: Left side image card & right side content aligned side-by-side in equal line */}
          ...
          <div className="about__content animate-reveal fade-left">
            ...
            <div className="about__features">
              ...
              <div className="about__feature">
                ...
                <div>
                  <h4 className="about__feature-title">Personalized Intelligence Reports</h4>
              ...
              <div className="about__feature">
                ...
                <div>
                  <h4 className="about__feature-title">Expert 1-on-1 Counselling</h4>
